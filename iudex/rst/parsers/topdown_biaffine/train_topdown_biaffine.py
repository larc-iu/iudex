...
def train(cfg: TopdownBiaffineConfig) -> None:
    ...
    train_trees = [t for _, t in read_rst_dir(cfg.train_dir, relation_types=cfg.relation_types)]
    dev_pairs = read_rst_dir(cfg.dev_dir, relation_types=cfg.relation_types)
